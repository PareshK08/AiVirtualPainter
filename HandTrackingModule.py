...
class HandDetector():
    ...
    def findHands(self, img, draw=True):
        ...
        # To check if the hand is detected or not
    ...
    def findPosition(self, img, handNo=0, draw=True):   
        ...
        if self.results.multi_hand_landmarks:
            ...
            for id, lm in enumerate(myHand.landmark):
                ...
                # To print circle on the landmarks
    ...
    def findDistance(self, p1, p2, img, draw=True, r=15, t=3):
        ...
        if draw:
            ...
            cv2.circle(img, (x1, y1), r, (200, 100, 200), cv2.FILLED)
            cv2.circle(img, (x2, y2), r, (200, 100, 200), cv2.FILLED)
            cv2.circle(img, (cx, cy), r, (221, 234, 205), cv2.FILLED)
